class Monkey:
    ...
    def evalItems(self, mList, divisibility):
        for old in self.items:
            self.inspections += 1
            old = (eval(self.operation)) % divisibility #// 3
...
def part1():
    ...
    #Part 2 addition: To keep worry level manageable, use least common multiple to reduce the danged thing,
    divisibility = 1
    for m in monkeylist:
    ...
    for _ in range(10000):
        for monkey in monkeylist:
            monkey.evalItems(monkeylist, divisibility)
